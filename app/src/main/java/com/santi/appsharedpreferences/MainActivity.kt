...
class MainActivity : AppCompatActivity() {
    ...
    private fun cargarDatos() {
        ...
        val intent = Intent(this, otraPantalla::class.java)

        //se crea el bundle para pasar la informacion entre activities
        val miBundle: Bundle = Bundle()
        miBundle.putString("user", user)
        miBundle.putString("pass", pass)

        //Se agrega la informacion al intent para que sea enviada
        intent.putExtras(miBundle)
        //se inicia el llamado a la nueva actividad
